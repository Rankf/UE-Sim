...
PerformanceLogger::EnsureSoftUeLogsOpen ()
{
  ...
  m_softUeCompletionLog
      ...
      << "ReadStageNetworkQueueSerializationNs,ReadStageTpdcTransportSendSerializationNs,"
      << "ReadStageReturnPathDataFragmentDelayNs,ReadStageTpdcSendWindowQueued,"
      << "ReadStageNetworkReorderHoldNs,"
      << "ReadStageRequesterVisibilityNs,"
...
PerformanceLogger::LogSoftUeCompletion (const SoftUeCompletionRecord& record)
{
  ...
  m_softUeCompletionLog
      ...
      << (record.read_stage_tpdc_send_window_queued ? 1 : 0) << ","
