...
PerformanceLogger::EnsureSoftUeLogsOpen ()
{
  ...
  m_softUeCompletionLog
      ...
      << "ReadStageValid,ReadStageResponderBudgetGenerateNs,ReadStageFirstResponseVisibleNs,"
      << "ReadStageReassemblyCompleteNs,ReadStageTerminalNs,ReadStageEndToEndNs" << std::endl;
...
PerformanceLogger::LogSoftUeCompletion (const SoftUeCompletionRecord& record)
{
  ...
  m_softUeCompletionLog
      ...
      << record.read_stage_end_to_end_ns << std::endl;
