...
- **Location**: `src/soft-ue/model/ses/ses-manager.cc`
- **Functionality**:
...
- **Key Features**: Context-aware packet processing and intelligent routing

#### PDS (Packet Delivery Sub-layer) Manager
- **Location**: `src/soft-ue/model/pds/pds-manager.cc`
- **Functionality**:
  - Packet distribution and routing
  - PDC management and coordination
  - Performance statistics collection
  - Load balancing and congestion-aware delivery
- **Key Features**: Intelligent packet distribution with performance monitoring

#### PDC (Packet Delivery Context) Layer
- **Location**: `src/soft-ue/model/pdc/`
- **Components**:
  - `pdc-base.cc` - Base PDC implementation
  - `ipdc.cc` - Unreliable PDC
  - `tpdc.cc` - Reliable PDC with RTO management
- **Functionality**: Reliable/unreliable transport with timeout management
- **Key Features**: Advanced flow control and performance optimization

#### Network Integration Layer
- **Location**: `src/soft-ue/model/network/`
- **Components**:
  - `soft-ue-net-device.cc` - Network device abstraction
  - `soft-ue-channel.cc` - Communication channel management
- **Functionality**: Seamless ns-3 framework integration
- **Key Features**: Standard ns-3 NetDevice and Channel implementations
...
```
        /\
       /  \
      / E2E \          ← End-to-end integration tests (Soft-UE/Soft-UE.cc)
     /______\
    /        \
   /Integration\       ← Component integration tests
  /____________\
  /            \
 / Unit Tests   \        ← Module-level unit tests
/______________/
```
